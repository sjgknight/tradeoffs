...
export { ActionStep, WhileLoop, ForLoop, ForEach, EachPlayer, SwitchCase, IfElse, EveryPlayer, Do, FlowControl };
 ...
 * @category Flow
 */
export declare const playerActions: (options: ConstructorParameters<typeof ActionStep>[0]) => ActionStep;
/**
 ...
 * @category Flow
 */
export declare const whileLoop: (options: ConstructorParameters<typeof WhileLoop>[0]) => WhileLoop;
/**
 ...
 * @category Flow
 */
export declare const loop: (...block: FlowStep[]) => WhileLoop;
/**
 ...
 * @category Flow
 */
export declare const forLoop: <T = Serializable>(options: {
    name: string;
    initial: T | ((a: import("./flow.js").FlowArguments) => T);
    next: (a: T) => T;
    while: (a: T) => boolean;
    do: import("./flow.js").FlowDefinition;
}) => ForLoop<T>;
/**
 ...
 * @category Flow
 */
export declare const forEach: <T extends Serializable>(options: {
    name: string;
    collection: T[] | ((a: import("./flow.js").FlowArguments) => T[]);
    do: import("./flow.js").FlowDefinition;
}) => ForEach<T>;
/**
 ...
 * @category Flow
 */
export declare const eachPlayer: (options: ConstructorParameters<typeof EachPlayer>[0]) => EachPlayer<import("../index.js").Player<import("../board/game.js").BaseGame, import("../player/player.js").BasePlayer>>;
/**
 ...
 * @category Flow
 */
export declare const ifElse: (options: ConstructorParameters<typeof IfElse>[0]) => IfElse;
/**
 ...
 * @category Flow
 */
export declare const switchCase: <T extends Serializable>(options: {
    name?: string | undefined;
    switch: T | ((a: import("./flow.js").FlowArguments) => T);
    cases: import("./switch-case.js").SwitchCaseCases<T>;
    default?: import("./flow.js").FlowDefinition | undefined;
}) => SwitchCase<T>;
/**
 ...
 * @category Flow
 */
export declare const everyPlayer: (options: ConstructorParameters<typeof EveryPlayer>[0]) => EveryPlayer<import("../index.js").Player<import("../board/game.js").BaseGame, import("../player/player.js").BasePlayer>>;
