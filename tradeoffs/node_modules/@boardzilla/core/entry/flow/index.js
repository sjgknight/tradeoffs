 ...
 * @category Flow
 */
export const playerActions = (options) => new ActionStep(options);
/**
 ...
 * @category Flow
 */
export const whileLoop = (options) => new WhileLoop(options);
/**
 ...
 * @category Flow
 */
export const loop = (...block) => new WhileLoop({ do: block, while: () => true });
/**
 ...
 * @category Flow
 */
export const forLoop = (options) => new ForLoop(options);
/**
 ...
 * @category Flow
 */
export const forEach = (options) => new ForEach(options);
/**
 ...
 * @category Flow
 */
export const eachPlayer = (options) => new EachPlayer(options);
/**
 ...
 * @category Flow
 */
export const ifElse = (options) => new IfElse(options);
/**
 ...
 * @category Flow
 */
export const switchCase = (options) => new SwitchCase(options);
/**
 ...
 * @category Flow
 */
export const everyPlayer = (options) => new EveryPlayer(options);
